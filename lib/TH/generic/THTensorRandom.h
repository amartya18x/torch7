...
TH_API void THTensor_(alias_multinomial_setup)(THTensor *prob_dist, THLongTensor *J, THTensor *q);
TH_API void THTensor_(alias_multinomial_batchdraw)(THLongTensor *self, THGenerator *_generator, THLongTensor *J, THTensor *q);
#endif
